...
<head>
  ...
  <link rel="stylesheet" href="{{asset('plugins/dist/css/skins/skin-blue.min.css')}}">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>I</b>OL</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>I</b>nmovil</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-success">@yield('cantidadMensajes','0')</span>
            </a>
            <ul class="dropdown-menu">
              <li class="header">You have @yield('cantidadMensajes','0') messages</li>
              <li>
          ...
          <li class="dropdown notifications-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-warning">@yield('cantidadNotificaciones','0')</span>
            </a>
            <ul class="dropdown-menu">
              <li class="header">You have @yield('cantidadNotificaciones','0') notifications</li>
              <li>
          ...
          <li class="dropdown tasks-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-danger">@yield('cantidadTareas','0')</span>
            </a>
            <ul class="dropdown-menu">
              <li class="header">You have @yield('cantidadTareas','0') tasks</li>
              <li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Interesados</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Propietarios</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('sistema/interesados/') }}">Ver pagos</a></li>
            <li><a href="{{ url('sistema/interesados/create') }}">Gestionar</a></li>
            <li><a href="#">Buscar</a></li>
          </ul>
        </li>
